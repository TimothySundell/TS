...
DEPRACATED! Instead, use TS_plot_IG_usage() Plot the Ig usage from two
groups and perform Fisher's Exact Test to find significant differences.
...
- file_type:
  ...
  Set type of file/annotation input. Defaults to "IMGT". Options are
  "IMGT" and "AIRR".
