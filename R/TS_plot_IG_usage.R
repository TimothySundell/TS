...
# 250508
# Add "flavour = c("cellranger", "IMGT", "AIRR")
# Or make this into separate function for each flavour?
# IMGT requires some formatting before running the script, renaming columns and extracting data
# e.g. if(flavour = "IMGT){TS_IMGT_to_cellranger(input_file)}
# Which then extracts all information, this could be based on what "chain" and the compare_what statement.
# Automatic filtering of the chain column
...
TS_plot_IG_usage <-
  function(input_file,
    ...
    # IMGT
    if(file_type == "IMGT"){
      input_file <- TS_format_IMGT_to_cellranger(imgt_data = input_file, grouping_variable = grouping_variable, sample1 = sample1, sample2 = sample2)
    }
    ...
    if(compare_what == "IGHV"){
      ...
      export_pdf_filename <- paste0("IGHV_usage_", sample1, "_vs_", sample2, ".pdf")
      export_pdf_message <- paste0("\n  Plot exported to:\n  ", getwd(), "\n\n  With the filename:\n  ", export_pdf_filename)
    }
    ...
    if(compare_what == "IGHV_FAMILY"){
      ...
      export_pdf_filename <- paste0("IGHV_family_usage_", sample1, "_vs_", sample2, ".pdf")
      export_pdf_message <- paste0("\n  Plot exported to:\n  ", getwd(), "\n\n  With the filename:\n  ", export_pdf_filename)
    }
    ...
    if(compare_what == "IGHV_FAMILY_GROUPED"){
      ...
      plot_title <- paste0("IGHV family usage - ", sample1, " vs ", sample2)
      export_pdf_filename <- paste0("IGHV_family_usage_grouped_", sample1, "_vs_", sample2, ".pdf")
      export_pdf_message <- paste0("\n  Plot exported to:\n  ", getwd(), "\n\n  With the filename:\n  ", export_pdf_filename)
    }
    # IGHD usage
    if(compare_what == "IGHD"){
      ...
      export_pdf_filename <- paste0("IGHD_usage_", sample1, "_vs_", sample2, ".pdf")
      export_pdf_message <- paste0("\n  Plot exported to:\n  ", getwd(), "\n\n  With the filename:\n  ", export_pdf_filename)
    ...
    if(compare_what == "IGHD_FAMILY"){
      ...
      export_pdf_filename <- paste0("IGHD_family_usage_", sample1, "_vs_", sample2, ".pdf")
      export_pdf_message <- paste0("\n  Plot exported to:\n  ", getwd(), "\n\n  With the filename:\n  ", export_pdf_filename)
      if(file_type == "cellranger"){
        message("You are comparing IGHD usage with data from Cell Ranger. This is not advisable to do as they usually map <50% of the genes\nAnyway, continuing...")
      }
    ...
    if(compare_what == "IGHJ"){
      ...
      export_pdf_filename <- paste0("IGHJ_usage_", sample1, "_vs_", sample2, ".pdf")
      export_pdf_message <- paste0("\n  Plot exported to:\n  ", getwd(), "\n\n  With the filename:\n  ", export_pdf_filename)
    }
    ...
    if(compare_what == "IGKV"){
      ...
      export_pdf_filename <- paste0("IGKV_usage_", sample1, "_vs_", sample2, ".pdf")
      export_pdf_message <- paste0("\n  Plot exported to:\n  ", getwd(), "\n\n  With the filename:\n  ", export_pdf_filename)
    }
    ...
    if(compare_what == "IGKV_FAMILY"){
      ...
      export_pdf_filename <- paste0("IGKV_family_usage_", sample1, "_vs_", sample2, ".pdf")
      export_pdf_message <- paste0("\n  Plot exported to:\n  ", getwd(), "\n\n  With the filename:\n  ", export_pdf_filename)
    }
    ...
    if(compare_what == "IGKJ"){
      ...
      export_pdf_filename <- paste0("IGKJ_usage_", sample1, "_vs_", sample2, ".pdf")
      export_pdf_message <- paste0("\n  Plot exported to:\n  ", getwd(), "\n\n  With the filename:\n  ", export_pdf_filename)
    }
    ...
    if(compare_what == "IGLV"){
      ...
      export_pdf_filename <- paste0("IGLV_usage_", sample1, "_vs_", sample2, ".pdf")
      export_pdf_message <- paste0("\n  Plot exported to:\n  ", getwd(), "\n\n  With the filename:\n  ", export_pdf_filename)
    }
    ...
    if(compare_what == "IGLV_FAMILY"){
      ...
      export_pdf_filename <- paste0("IGLV_family_usage_", sample1, "_vs_", sample2, ".pdf")
      export_pdf_message <- paste0("\n  Plot exported to:\n  ", getwd(), "\n\n  With the filename:\n  ", export_pdf_filename)
    }
    ...
    if(compare_what == "IGLJ"){
      ...
      export_pdf_filename <- paste0("IGLJ_usage_", sample1, "_vs_", sample2, ".pdf")
      export_pdf_message <- paste0("\n  Plot exported to:\n  ", getwd(), "\n\n  With the filename:\n  ", export_pdf_filename)
    }
    ...
    if(compare_what == "IGLC"){
      ...
      export_pdf_filename <- paste0("IGLC_usage_", sample1, "_vs_", sample2, ".pdf")
      export_pdf_message <- paste0("\n  Plot exported to:\n  ", getwd(), "\n\n  With the filename:\n  ", export_pdf_filename)
    }
    ...
    # Otherwise plot the resulting IG-usage chart with stats-results denoted
      ...
      if(length(gene_list_levels_plotting) == 0){
        stop("Error: Gene list for plotting has 0 entries")
      }
      ...
      plot_data <- input_file %>%
        ...
        tidyr::complete(gene_list, grouping_variable, fill = list(count = 0.1)) %>%
        dplyr::group_by(grouping_variable) %>%
